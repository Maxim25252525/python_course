...
class Tank:
    ...
    Args:
        rows: Индексы строк, где расположен танк.
        column: Индекс столбца, где расположен танк.
...
class Shot:
    """
    Класс, описывающий выстрел.

    Args:
        row: Индекс строки, куда произведен выстрел.
        column: Индекс столбца, куда произведен выстрел.

    Attributes:
        row: Индекс строки, куда произведен выстрел.
        column: Индекс столбца, куда произведен выстрел.
        hit: Признак попадания.
    """
