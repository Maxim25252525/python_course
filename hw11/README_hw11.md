...
4. Запустить тесты к 11-му домашнему заданию.
5. Создать Pull Request на Github для проверки ДЗ.

## Часть 1
1. Перейдите на ветку main и обновите ее через Update Project.
2. Создайте новую ветку от main в PyCharm под названием "hw11".
3. Загрузите и распакуйте архив с 11 домашним заданием из iSpring.
...
## Часть 4
1. Запустите тесты через консоль с помощью команды `pytest hw11/`.
...
Слева должна быть ветка "main", то есть ветка вашего репозитория, справа - "hw11".
