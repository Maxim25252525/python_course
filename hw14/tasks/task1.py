...
class Card:
    ...
    Attributes:
        ...
        _payment_system: Платежная система карты.
    ...
    def get_number(self) -> str:
        ...
        """
        return self.get_cv() + str(self.__number)[-4:]
    ...
    def put_money(self, money: float, pin_code: int):
        ...
        if self.__pin_code != pin_code:
            ...
            raise ValueError(
                "Количество средств для внесения должно быть больше 0"
            )
        self._balance += money
